...
public class RabbitMQConfig {
    ...
    public Queue insightQueue() {
        ...
        return new Queue(RabbitMQConstants.INSIGHT_QUEUE, true, false, true, args);
    }
    @Bean
    public Binding insightAnalyzeCreatedBinding(Queue commitCreatedQueue, TopicExchange commitExchange) {
        return BindingBuilder.bind(commitCreatedQueue).to(commitExchange).with(RabbitMQConstants.INSIGHT_ANALYZE_CREATED_ROUTING_KEY);
    }
}
